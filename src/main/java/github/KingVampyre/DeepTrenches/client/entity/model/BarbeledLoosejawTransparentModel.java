...
public class BarbeledLoosejawTransparentModel extends AnimatedEntityModel<deep_trenches:barbeled_loosejaw_transparent> {
    ...
    root = new AnimatedModelRenderer(this);
		...
		Eyeinnerside1.setRotationPoint(3.0F, -1.45F, -8.4F);
		Upper_Jaw.addChild(Eyeinnerside1);
		Eyeinnerside1.setTextureOffset(13, 17).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
		...
		Eyeouterside1.setRotationPoint(0.0F, -0.6F, 1.0F);
		Eyeinnerside1.addChild(Eyeouterside1);
		Eyeouterside1.setTextureOffset(0, 15).addBox(-2.7F, 0.0F, -1.7F, 3.0F, 3.0F, 3.0F, 0.0F, true);
		...
		Eyeinnerside2.setRotationPoint(-2.0F, -1.45F, -8.4F);
		...
		Eyeouterside2.setRotationPoint(1.6F, -0.6F, 1.0F);
		Eyeinnerside2.addChild(Eyeouterside2);
		Eyeouterside2.setTextureOffset(0, 15).addBox(-3.0F, 0.0F, -1.7F, 3.0F, 3.0F, 3.0F, 0.0F, false);
		...
		Upper_teeth_side_2.setRotationPoint(-2.4F, 2.8F, -9.7F);
		Upper_Jaw.addChild(Upper_teeth_side_2);
		Upper_teeth_side_2.setTextureOffset(0, 36).addBox(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 6.0F, 0.0F, false);
		...
		Upper_teeth_side_1.setRotationPoint(2.4F, 2.8F, -9.7F);
		Upper_Jaw.addChild(Upper_teeth_side_1);
		Upper_teeth_side_1.setTextureOffset(0, 36).addBox(0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 6.0F, 0.0F, false);
		...
		Front_upper_teeth.setRotationPoint(0.0F, 3.0F, -10.7F);
		...
		Lower_jaw.setTextureOffset(32, 27).addBox(-2.5F, -2.0F, -12.1F, 5.0F, 1.0F, 13.0F, 0.0F, false);
		Lower_jaw.setModelRendererName("Lower_jaw");
		this.registerModelRenderer(Lower_jaw);

		Fronttooth = new AnimatedModelRenderer(this);
		Fronttooth.setRotationPoint(0.0F, -2.0F, -12.5F);
		Lower_jaw.addChild(Fronttooth);
		setRotationAngle(Fronttooth, 0.2731F, 0.0F, 0.0F);
		Fronttooth.setTextureOffset(32, 32).addBox(0.0F, -3.6F, 0.0F, 0.0F, 4.0F, 2.0F, 0.0F, false);
		...
		Teeth_side_1.setRotationPoint(2.4F, -2.0F, -10.8F);
		Lower_jaw.addChild(Teeth_side_1);
		Teeth_side_1.setTextureOffset(0, 31).addBox(0.0F, -1.9F, 0.0F, 0.0F, 2.0F, 8.0F, 0.0F, false);
		...
		Teeth_side_2.setRotationPoint(-2.4F, -2.0F, -10.8F);
		Lower_jaw.addChild(Teeth_side_2);
		Teeth_side_2.setTextureOffset(0, 31).addBox(0.0F, -1.9F, 0.0F, 0.0F, 2.0F, 8.0F, 0.0F, false);
		...
		Front_tooth_side_2.setRotationPoint(-2.4F, -2.0F, -11.8F);
		Lower_jaw.addChild(Front_tooth_side_2);
		setRotationAngle(Front_tooth_side_2, 0.192F, 0.0F, 0.0F);
		Front_tooth_side_2.setTextureOffset(36, 34).addBox(0.0F, -2.4F, 0.0F, 0.0F, 3.0F, 1.0F, 0.0F, false);
		...
		Front_tooth_side_1.setRotationPoint(2.4F, -2.0F, -11.8F);
		Lower_jaw.addChild(Front_tooth_side_1);
		setRotationAngle(Front_tooth_side_1, 0.192F, 0.0F, 0.0F);
		Front_tooth_side_1.setTextureOffset(36, 34).addBox(0.0F, -2.4F, 0.0F, 0.0F, 3.0F, 1.0F, 0.0F, false);
		...
		Barbel_joint.setRotationPoint(0.0F, -1.0F, -5.0F);
		Lower_jaw.addChild(Barbel_joint);
		setRotationAngle(Barbel_joint, 0.0911F, 0.0F, 0.0F);
		...
		Barbel.setRotationPoint(0.4F, -2.0F, 0.0F);
		Barbel_joint.addChild(Barbel);
		Barbel.setTextureOffset(0, 0).addBox(0.0F, 2.0F, 0.0F, 0.0F, 16.0F, 1.0F, 0.0F, false);
		Barbel.setModelRendererName("Barbel");
		this.registerModelRenderer(Barbel);

		Barbel_tip = new AnimatedModelRenderer(this);
		Barbel_tip.setRotationPoint(0.5F, 17.1F, 0.0F);
		...
		Tail.setRotationPoint(0.0F, 0.2F, 15.3F);
		Body.addChild(Tail);
		Tail.setTextureOffset(43, 45).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 6.0F, 11.0F, 0.0F, false);
		Tail.setModelRendererName("Tail");
		this.registerModelRenderer(Tail);

		Dorsal_fin = new AnimatedModelRenderer(this);
		Dorsal_fin.setRotationPoint(0.0F, 0.0F, 4.4F);
		Tail.addChild(Dorsal_fin);
		Dorsal_fin.setTextureOffset(70, 37).addBox(0.0F, -3.7F, 0.0F, 0.0F, 5.0F, 6.0F, 0.0F, false);
		Dorsal_fin.setModelRendererName("Dorsal_fin");
		this.registerModelRenderer(Dorsal_fin);

		Anal_fin = new AnimatedModelRenderer(this);
		Anal_fin.setRotationPoint(-0.1F, 4.9F, 5.0F);
		...
		Caudal_fin.setRotationPoint(0.0F, 3.0F, 11.0F);
		...
		Pectoral_fin_side_1.setRotationPoint(2.5F, 6.9F, 1.0F);
		Body.addChild(Pectoral_fin_side_1);
		setRotationAngle(Pectoral_fin_side_1, 0.4643F, 0.0F, -0.1396F);
		Pectoral_fin_side_1.setTextureOffset(2, 0).addBox(0.0F, 0.0F, -0.8F, 0.0F, 9.0F, 3.0F, 0.0F, false);
		...
		Pectoral_fin_side_2.setRotationPoint(-2.5F, 6.9F, 1.0F);
		Body.addChild(Pectoral_fin_side_2);
		setRotationAngle(Pectoral_fin_side_2, 0.4643F, 0.0F, 0.1396F);
		Pectoral_fin_side_2.setTextureOffset(2, 0).addBox(0.0F, 0.0F, -0.8F, 0.0F, 9.0F, 3.0F, 0.0F, false);
		...
		Pelvic_fin_side_1.setRotationPoint(2.5F, 6.6F, 10.8F);
		Body.addChild(Pelvic_fin_side_1);
		setRotationAngle(Pelvic_fin_side_1, 0.0349F, 0.0F, -0.1396F);
		Pelvic_fin_side_1.setTextureOffset(8, -1).addBox(0.0F, 0.0F, -0.4F, 0.0F, 8.0F, 5.0F, 0.0F, false);
		...
		Pelvic_fin_side_2.setRotationPoint(-2.5F, 6.6F, 10.4F);
