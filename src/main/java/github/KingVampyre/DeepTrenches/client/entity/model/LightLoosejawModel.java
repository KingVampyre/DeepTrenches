...
public class LightLoosejawModel extends AnimatedEntityModel<deep_trenches:light_loosejaw> {
    ...
    root = new AnimatedModelRenderer(this);
		...
		Upper_Jaw.setRotationPoint(0.0F, 3.1F, 1.0F);
