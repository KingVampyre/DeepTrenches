...
public class DeepTrenchesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.LEKRAL_CLUSTER, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.BROWN_PANSY, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.LIMEFORK, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.PINK_AND_ORANGE_PANSY, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.PURPLE_AND_ORANGE_PANSY, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.RED_PANSY, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.SPIDREET, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.SQUISACLE, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.WEEPISTIL, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.WEEPY_HOLLOWER, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.WHEEPING_AZURE_BLOOM, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.TALL_BUCKTHORN, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.BUCKTHORN, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.BULK_GRASSES, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.CRUSTED_FUNGUS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.FOUR_LEAFED_CLOVER, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.FRAREL, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.FUR_PLATEAU, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.HARSHLES, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.ILYINE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.JUNGLE_UMBRELLA, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.LICHEN, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.MOSSES, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.MURKSTEM, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.POMEGRANATE_BUSH, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.REEBLOON, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.SEA_BUCKTHORN, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(DTBlocks.THREE_LEAFED_CLOVER, RenderLayer.getCutout());
