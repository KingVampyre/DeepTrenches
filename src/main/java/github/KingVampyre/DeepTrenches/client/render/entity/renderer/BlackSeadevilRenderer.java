...
public class BlackSeadevilRenderer extends NoCullingEntityRenderer<BlackSeadevilEntity> {
    ...
    private static final RenderLayer[] LAYERS = {
            CustomRenderLayer.getBrightOverlayTexture(new Identifier("deep_trenches:textures/entity/black_seadevil/all_lit_layer.png")),
            CustomRenderLayer.getBrightOverlayTexture(new Identifier("deep_trenches:textures/entity/black_seadevil/all_unlit_layer.png"))
    };
