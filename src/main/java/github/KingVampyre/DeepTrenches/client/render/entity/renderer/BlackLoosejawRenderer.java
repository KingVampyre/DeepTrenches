...
public class BlackLoosejawRenderer extends MobEntityRenderer<BlackLoosejawEntity, BlackLoosejawModel> {
    ...
    private static final Identifier[] NORTHERN_BLACK_LOOSEJAW = {
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/all_lit.png"),
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/all_unlit.png"),
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/flank.png"),
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/flank_and_lure.png"),
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/flank_and_suborbital.png"),
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/lure.png"),
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/suborbital.png"),
            new Identifier("deep_trenches:textures/entity/barbeled_loosejaw/northern/suborbital_and_lure.png")
    };

    private static final Identifier[] SOUTHERN_BARBELED_LOOSEJAW = {
    ...
    public Identifier getTexture(BlackLoosejawEntity entity) {
        ...
        switch (entity.getLoosejawType()) {
            ...
            case 1:
                return SOUTHERN_BARBELED_LOOSEJAW[1];
        }
