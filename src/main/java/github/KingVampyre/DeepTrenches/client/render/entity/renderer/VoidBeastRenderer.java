...
public class VoidBeastRenderer extends NoCullingEntityRenderer<VoidBeastEntity> {
    ...
    private static final RenderLayer[] LAYERS = {
            CustomRenderLayer.getBrightOverlayTexture(new Identifier("deep_trenches:textures/entity/void_beast/all_lit_layer.png")),
            CustomRenderLayer.getBrightOverlayTexture(new Identifier("deep_trenches:textures/entity/void_beast/all_unlit_layer.png")),
            CustomRenderLayer.getBrightOverlayTexture(new Identifier("deep_trenches:textures/entity/void_beast/tail_layer.png")),
            CustomRenderLayer.getBrightOverlayTexture(new Identifier("deep_trenches:textures/entity/void_beast/tongue_layer.png"))
    };
