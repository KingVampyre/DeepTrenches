...
public class SmalltoothDragonfishLayer extends DoubleLayerRenderer<SmalltoothDragonfishEntity> {
    ...
    private static final Identifier[] TEXTURES = {
            ...
            new Identifier("deep_trenches:textures/entity/smalltooth_dragonfish/all_unlit_layer.png"),
    ...
    @Override
    protected RenderLayer getSecondaryRenderLayer(SmalltoothDragonfishEntity living) {
