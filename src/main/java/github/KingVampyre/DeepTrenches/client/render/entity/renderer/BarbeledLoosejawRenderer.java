...
public class BarbeledLoosejawRenderer extends MobEntityRenderer<BarbeledLoosejawEntity, BarbeledLoosejawModel> {
    ...
    public Identifier getTexture(BarbeledLoosejawEntity entity) {
        ...
        switch (entity.getLoosejawType()) {
            case 0:
                return ATLANTIC_BARBELED_LOOSEJAW[1];
            case 1:
                return GLOWING_BARBELED_LOOSEJAW[1];
            case 2:
                return GRIMALDIS_BARBELED_LOOSEJAW[1];
            case 3:
                return MANY_RAYED_BARBELED_LOOSEJAW[1];
            case 4:
                return SHINY_BARBELED_LOOSEJAW[1];
            case 5:
                return TITTMANNS_BARBELED_LOOSEJAW[1];
        }
