...
import static github.KingVampyre.DeepTrenches.client.init.ColorMaps.STORCEAN_HADOPELAGIC_WATER;
    ...
    public int getColor(@Nullable BlockRenderView view, @Nullable BlockPos pos, FluidState state) {
        ...
        if (view != null && pos != null)
            return view.getColor(pos, (biome, x, z) -> {
                ...
                return STORCEAN_HADOPELAGIC_WATER.getColor(temperature, humidity);
            });

        return STORCEAN_HADOPELAGIC_WATER.getDefaultColor();
    }
