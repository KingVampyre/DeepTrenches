...
import static github.KingVampyre.DeepTrenches.client.init.ColorMaps.STORCEAN_WATER;
        ...
        if (view != null && pos != null) {
            ...
            if(client != null)
                return client.calculateColor(pos, (biome, x, z) -> {
                    ...
                    return STORCEAN_WATER.getColor(temperature, humidity);
                });

        }

        return STORCEAN_WATER.getDefaultColor();
    }
