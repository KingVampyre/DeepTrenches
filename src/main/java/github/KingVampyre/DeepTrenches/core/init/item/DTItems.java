...
import github.KingVampyre.DeepTrenches.core.init.DTArmorMaterials;
import github.KingVampyre.DeepTrenches.core.init.DTFluids;
import github.KingVampyre.DeepTrenches.core.init.DTToolMaterials;
import github.KingVampyre.DeepTrenches.core.init.block.DTBlocks;
import github.KingVampyre.DeepTrenches.core.init.entity.DTBoatTypes;
...
import static github.KingVampyre.DeepTrenches.core.init.item.DTFoodComponents.STORCEAN_FISH;
import static github.KingVampyre.DeepTrenches.core.init.item.DTItemGroups.*;
...
public class DTItems {
	...
	public static void initialize() {
		...
		registerBlockItem("deep_trenches:storcendite_actinium_ore", STORCENDITE_ACTINIUM_ORE, MINERALOGY);
