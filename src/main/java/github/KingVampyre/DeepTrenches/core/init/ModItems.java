...
public class ModItems {
	...
	public static final Item BARBELED_LOOSEJAW_BUCKET = new ModFishBucketItem(EntityTypes.BARBELED_LOOSEJAW, WATER, new Settings().maxCount(1).group(GENERAL));
	...
	public static final Item BETTA_BUCKET = new ModFishBucketItem(EntityTypes.BETTA, WATER, new Settings().maxCount(1).group(GENERAL));
	...
	public static final Item BLACK_LOOSEJAW_BUCKET = new ModFishBucketItem(EntityTypes.BLACK_LOOSEJAW, WATER, new Settings().maxCount(1).group(GENERAL));
	...
	public static final Item LIGHT_LOOSEJAW_BUCKET = new ModFishBucketItem(EntityTypes.LIGHT_LOOSEJAW, WATER, new Settings().maxCount(1).group(GENERAL));
