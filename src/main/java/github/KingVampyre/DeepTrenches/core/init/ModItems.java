...
public class ModItems {
	...
	protected static void createSignItem(String id, Block standingBlock, Block block, ItemGroup itemGroup) {
		register(id, new SignItem(new Settings().maxCount(16).group(itemGroup), standingBlock, block));
	}
	...
	protected static void createWallStandingItem(String id, Block standingBlock, Block block, ItemGroup itemGroup) {
		register(id, new WallStandingBlockItem(standingBlock, block, new Settings().maxCount(1).group(itemGroup)));
	}
	...
	static {
		...
		createWallStandingItem("deep_trenches:cabbage_tree_coral_fan", CABBAGE_TREE_CORAL_FAN, CABBAGE_TREE_CORAL_WALL_FAN, GENERAL);
		...
		createBlockItem("deep_trenches:light_opalite", LIGHT_OPALITE, GENERAL);
		createBlockItem("deep_trenches:lushine", LUSHINE, GENERAL);
		createBlockItem("deep_trenches:lushine_pillar", LUSHINE_PILLAR, GENERAL);
		createBlockItem("deep_trenches:lustrite", LUSTRITE, GENERAL);
		createBlockItem("deep_trenches:marine_snow", MARINE_SNOW, GENERAL);
		createBlockItem("deep_trenches:opalite", OPALITE, GENERAL);
		createBlockItem("deep_trenches:rhodonite", RHODONITE, GENERAL);
		createBlockItem("deep_trenches:storcean_marine_snow", STORCEAN_MARINE_SNOW, GENERAL);
		createBlockItem("deep_trenches:storcendite", STORCENDITE, GENERAL);
		createBlockItem("deep_trenches:storcerack", STORCERACK, GENERAL);
		...
		createBlockItem("deep_trenches:poinine", POININE, GENERAL);
