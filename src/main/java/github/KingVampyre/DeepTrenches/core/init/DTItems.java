...
public class DTItems {
	...
	protected static Item createBoat(String id, FabricBoatType type) {
		return register(id, new FabricBoatItem(DTEntityTypes.BOAT, type, new Item.Settings().maxCount(1).group(PHYTOLOGY)));
	}
	...
	protected static void createSignItem(String id, Block standingBlock, Block block) {
		register(id, new SignItem(new Settings().maxCount(16).group(PHYTOLOGY), standingBlock, block));
	}
	...
	static {
		...
		createBlockItem("deep_trenches:almond_button", ALMOND_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_button", ANAMEATA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_button", ANGELS_TRUMPET_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_button", AQUEAN_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_button", BARSHROOKLE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_button", BLACK_BIRCH_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_button", BLUE_MAHOE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_button", BLUE_SPRUCE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_button", BOTTLEBRUSH_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_button", BROMYA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_button", BUBBLETREE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_button", CALCEARB_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_button", CHERRY_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_button", CHOTORN_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_button", COOK_PINE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_button", CROLOOD_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_button", DARK_CROLOOD_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_button", DARK_FUCHSITRA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_button", DARK_RED_ELM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_button", DEAD_WART_TREE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_button", DRIGYUS_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_button", EBONY_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_button", ENDERHEART_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_button", FLALM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_button", FRUCE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_button", FUCHSITRA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_button", FUGMOS_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_button", FUNERANITE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_button", GHOSHROOM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_button", GIANT_VIOLET_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_button", GUAIACUM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_button", JOSHUA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_button", KLINKII_PINE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_button", MELALEUCA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_button", MURKANTUAN_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_button", NORFOLK_PINE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_button", OBSCRUS_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_button", ORHPRIS_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_button", PELTOGYNE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_button", PIN_CHERRY_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_button", PLUM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_button", PURFUNGA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_button", RARK_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_button", RED_ELM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_button", RHADI_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_button", SANGUART_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_button", SCARLET_THIORCEN_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_button", SPROOM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_button", SEQUOIA_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_button", STORTREEAN_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_button", STROOMEAN_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_button", SUNRISE_FUNGUS_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_button", TARK_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_button", TEAK_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_button", THUNDERCLOUD_PLUM_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_button", VYNHERT_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_button", WART_TREE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_button", WENGE_BUTTON, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_button", YEW_BUTTON, PHYTOLOGY);

		createBlockItem("deep_trenches:anameata_cap", ANAMEATA_CAP, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_cap", BARSHROOKLE_CAP, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_cap", FUNERANITE_CAP, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_cap", GHOSHROOM_CAP, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_cap", PURFUNGA_CAP, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_cap", STROOMEAN_CAP, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_cap", SUNRISE_FUNGUS_CAP, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_door", ALMOND_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_door", ANAMEATA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_door", ANGELS_TRUMPET_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_door", AQUEAN_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_door", BARSHROOKLE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_door", BLACK_BIRCH_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_door", BLUE_MAHOE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_door", BLUE_SPRUCE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_door", BOTTLEBRUSH_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_door", BROMYA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_door", BUBBLETREE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_door", CALCEARB_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_door", CHERRY_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_door", CHOTORN_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_door", COOK_PINE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_door", CROLOOD_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_door", DARK_CROLOOD_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_door", DARK_FUCHSITRA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_door", DARK_RED_ELM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_door", DEAD_WART_TREE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_door", DRIGYUS_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_door", EBONY_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_door", ENDERHEART_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_door", FLALM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_door", FRUCE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_door", FUCHSITRA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_door", FUGMOS_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_door", FUNERANITE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_door", GHOSHROOM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_door", GIANT_VIOLET_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_door", GUAIACUM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_door", JOSHUA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_door", KLINKII_PINE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_door", MELALEUCA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_door", MURKANTUAN_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_door", NORFOLK_PINE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_door", OBSCRUS_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_door", ORHPRIS_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_door", PELTOGYNE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_door", PIN_CHERRY_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_door", PLUM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_door", PURFUNGA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_door", RARK_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_door", RED_ELM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_door", RHADI_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_door", SANGUART_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_door", SCARLET_THIORCEN_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_door", SPROOM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_door", SEQUOIA_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_door", STORTREEAN_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_door", STROOMEAN_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_door", SUNRISE_FUNGUS_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_door", TARK_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_door", TEAK_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_door", THUNDERCLOUD_PLUM_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_door", VYNHERT_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_door", WART_TREE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_door", WENGE_DOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_door", YEW_DOOR, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_fence", ALMOND_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_fence", ANAMEATA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_fence", ANGELS_TRUMPET_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_fence", AQUEAN_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_fence", BARSHROOKLE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_fence", BLACK_BIRCH_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_fence", BLUE_MAHOE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_fence", BLUE_SPRUCE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_fence", BOTTLEBRUSH_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_fence", BROMYA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_fence", BUBBLETREE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_fence", CALCEARB_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_fence", CHERRY_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_fence", CHOTORN_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_fence", COOK_PINE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_fence", CROLOOD_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_fence", DARK_CROLOOD_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_fence", DARK_FUCHSITRA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_fence", DARK_RED_ELM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_fence", DEAD_WART_TREE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_fence", DRIGYUS_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_fence", EBONY_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_fence", ENDERHEART_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_fence", FLALM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_fence", FRUCE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_fence", FUCHSITRA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_fence", FUGMOS_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_fence", FUNERANITE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_fence", GHOSHROOM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_fence", GIANT_VIOLET_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_fence", GUAIACUM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_fence", JOSHUA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_fence", KLINKII_PINE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_fence", MELALEUCA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_fence", MURKANTUAN_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_fence", NORFOLK_PINE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_fence", OBSCRUS_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_fence", ORHPRIS_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_fence", PELTOGYNE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_fence", PIN_CHERRY_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_fence", PLUM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_fence", PURFUNGA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_fence", RARK_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_fence", RED_ELM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_fence", RHADI_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_fence", SANGUART_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_fence", SCARLET_THIORCEN_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_fence", SPROOM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_fence", SEQUOIA_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_fence", STORTREEAN_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_fence", STROOMEAN_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_fence", SUNRISE_FUNGUS_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_fence", TARK_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_fence", TEAK_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_fence", THUNDERCLOUD_PLUM_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_fence", VYNHERT_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_fence", WART_TREE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_fence", WENGE_FENCE, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_fence", YEW_FENCE, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_fence_gate", ALMOND_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_fence_gate", ANAMEATA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_fence_gate", ANGELS_TRUMPET_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_fence_gate", AQUEAN_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_fence_gate", BARSHROOKLE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_fence_gate", BLACK_BIRCH_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_fence_gate", BLUE_MAHOE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_fence_gate", BLUE_SPRUCE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_fence_gate", BOTTLEBRUSH_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_fence_gate", BROMYA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_fence_gate", BUBBLETREE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_fence_gate", CALCEARB_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_fence_gate", CHERRY_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_fence_gate", CHOTORN_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_fence_gate", COOK_PINE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_fence_gate", CROLOOD_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_fence_gate", DARK_CROLOOD_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_fence_gate", DARK_FUCHSITRA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_fence_gate", DARK_RED_ELM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_fence_gate", DEAD_WART_TREE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_fence_gate", DRIGYUS_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_fence_gate", EBONY_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_fence_gate", ENDERHEART_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_fence_gate", FLALM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_fence_gate", FRUCE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_fence_gate", FUCHSITRA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_fence_gate", FUGMOS_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_fence_gate", FUNERANITE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_fence_gate", GHOSHROOM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_fence_gate", GIANT_VIOLET_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_fence_gate", GUAIACUM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_fence_gate", JOSHUA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_fence_gate", KLINKII_PINE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_fence_gate", MELALEUCA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_fence_gate", MURKANTUAN_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_fence_gate", NORFOLK_PINE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_fence_gate", OBSCRUS_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_fence_gate", ORHPRIS_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_fence_gate", PELTOGYNE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_fence_gate", PIN_CHERRY_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_fence_gate", PLUM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_fence_gate", PURFUNGA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_fence_gate", RARK_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_fence_gate", RED_ELM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_fence_gate", RHADI_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_fence_gate", SANGUART_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_fence_gate", SCARLET_THIORCEN_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_fence_gate", SPROOM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_fence_gate", SEQUOIA_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_fence_gate", STORTREEAN_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_fence_gate", STROOMEAN_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_fence_gate", SUNRISE_FUNGUS_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_fence_gate", TARK_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_fence_gate", TEAK_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_fence_gate", THUNDERCLOUD_PLUM_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_fence_gate", VYNHERT_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_fence_gate", WART_TREE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_fence_gate", WENGE_FENCE_GATE, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_fence_gate", YEW_FENCE_GATE, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_leaves", ALMOND_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_leaves", ANGELS_TRUMPET_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_leaves", AQUEAN_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_leaves", BLACK_BIRCH_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_leaves", BLUE_MAHOE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_leaves", BLUE_SPRUCE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_leaves", BOTTLEBRUSH_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_leaves", BROMYA_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_leaves", CALCEARB_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_leaves", CHERRY_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_leaves", COOK_PINE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_leaves", CROLOOD_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_leaves", DARK_CROLOOD_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_leaves", DARK_FUCHSITRA_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_leaves", DARK_RED_ELM_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_leaves", EBONY_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_leaves", ENDERHEART_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_leaves", FRUCE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_leaves", FUCHSITRA_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_leaves", GUAIACUM_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_leaves", JOSHUA_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_leaves", KLINKII_PINE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_leaves", MELALEUCA_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_leaves", MURKANTUAN_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_leaves", NORFOLK_PINE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_leaves", OBSCRUS_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_leaves", ORHPRIS_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_leaves", PELTOGYNE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_leaves", PIN_CHERRY_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_leaves", PLUM_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_leaves", RARK_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_leaves", RED_ELM_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_leaves", RHADI_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_leaves", SANGUART_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_leaves", SPROOM_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_leaves", SEQUOIA_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_leaves", STORTREEAN_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_leaves", TARK_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_leaves", TEAK_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_leaves", THUNDERCLOUD_PLUM_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_leaves", WENGE_LEAVES, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_leaves", YEW_LEAVES, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_log", ALMOND_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_log", ANAMEATA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_log", ANGELS_TRUMPET_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_log", AQUEAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_log", BARSHROOKLE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_log", BLACK_BIRCH_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_log", BLUE_MAHOE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_log", BLUE_SPRUCE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_log", BOTTLEBRUSH_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_log", BROMYA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_log", BUBBLETREE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_log", CALCEARB_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_log", CHERRY_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_log", CHOTORN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_log", COOK_PINE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_log", CROLOOD_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_log", DARK_CROLOOD_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_log", DARK_FUCHSITRA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_log", DARK_RED_ELM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_log", DEAD_WART_TREE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_log", DRIGYUS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_log", EBONY_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_log", ENDERHEART_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_stem", FLALM_STEM, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_log", FRUCE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_log", FUCHSITRA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_stem", FUGMOS_STEM, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_log", FUNERANITE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_log", GHOSHROOM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_stem", GIANT_VIOLET_STEM, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_log", GUAIACUM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_log", JOSHUA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_log", KLINKII_PINE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_log", MELALEUCA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_log", MURKANTUAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_log", NORFOLK_PINE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_log", OBSCRUS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_log", ORHPRIS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_log", PELTOGYNE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_log", PIN_CHERRY_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_log", PLUM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_log", PURFUNGA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_log", RARK_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_log", RED_ELM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_log", RHADI_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_log", SANGUART_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_log", SCARLET_THIORCEN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_log", SPROOM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_log", SEQUOIA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_log", STORTREEAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_log", STROOMEAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_log", SUNRISE_FUNGUS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_log", TARK_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_log", TEAK_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_log", THUNDERCLOUD_PLUM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_log", VYNHERT_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_log", WART_TREE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_log", WENGE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:mossy_yew_log", MOSSY_YEW_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_log", YEW_LOG, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_planks", ALMOND_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_planks", ANAMEATA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_planks", ANGELS_TRUMPET_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_planks", AQUEAN_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_planks", BARSHROOKLE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_planks", BLACK_BIRCH_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_planks", BLUE_MAHOE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_planks", BLUE_SPRUCE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_planks", BOTTLEBRUSH_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_planks", BROMYA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_planks", BUBBLETREE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_planks", CALCEARB_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_planks", CHERRY_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_planks", CHOTORN_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_planks", COOK_PINE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_planks", CROLOOD_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_planks", DARK_CROLOOD_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_planks", DARK_FUCHSITRA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_planks", DARK_RED_ELM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_planks", DEAD_WART_TREE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_planks", DRIGYUS_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_planks", EBONY_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_planks", ENDERHEART_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_planks", FLALM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_planks", FRUCE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_planks", FUCHSITRA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_planks", FUGMOS_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_planks", FUNERANITE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_planks", GHOSHROOM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_planks", GIANT_VIOLET_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_planks", GUAIACUM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_planks", JOSHUA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_planks", KLINKII_PINE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_planks", MELALEUCA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_planks", MURKANTUAN_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_planks", NORFOLK_PINE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_planks", OBSCRUS_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_planks", ORHPRIS_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_planks", PELTOGYNE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_planks", PIN_CHERRY_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_planks", PLUM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_planks", PURFUNGA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_planks", RARK_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_planks", RED_ELM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_planks", RHADI_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_planks", SANGUART_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_planks", SCARLET_THIORCEN_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_planks", SPROOM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_planks", SEQUOIA_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_planks", STORTREEAN_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_planks", STROOMEAN_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_planks", SUNRISE_FUNGUS_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_planks", TARK_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_planks", TEAK_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_planks", THUNDERCLOUD_PLUM_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_planks", VYNHERT_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_planks", WART_TREE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_planks", WENGE_PLANKS, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_planks", YEW_PLANKS, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_pressure_plate", ALMOND_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_pressure_plate", ANAMEATA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_pressure_plate", ANGELS_TRUMPET_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_pressure_plate", AQUEAN_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_pressure_plate", BARSHROOKLE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_pressure_plate", BLACK_BIRCH_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_pressure_plate", BLUE_MAHOE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_pressure_plate", BLUE_SPRUCE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_pressure_plate", BOTTLEBRUSH_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_pressure_plate", BROMYA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_pressure_plate", BUBBLETREE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_pressure_plate", CALCEARB_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_pressure_plate", CHERRY_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_pressure_plate", CHOTORN_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_pressure_plate", COOK_PINE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_pressure_plate", CROLOOD_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_pressure_plate", DARK_CROLOOD_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_pressure_plate", DARK_FUCHSITRA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_pressure_plate", DARK_RED_ELM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_pressure_plate", DEAD_WART_TREE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_pressure_plate", DRIGYUS_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_pressure_plate", EBONY_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_pressure_plate", ENDERHEART_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_pressure_plate", FLALM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_pressure_plate", FRUCE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_pressure_plate", FUCHSITRA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_pressure_plate", FUGMOS_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_pressure_plate", FUNERANITE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_pressure_plate", GHOSHROOM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_pressure_plate", GIANT_VIOLET_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_pressure_plate", GUAIACUM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_pressure_plate", JOSHUA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_pressure_plate", KLINKII_PINE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_pressure_plate", MELALEUCA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_pressure_plate", MURKANTUAN_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_pressure_plate", NORFOLK_PINE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_pressure_plate", OBSCRUS_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_pressure_plate", ORHPRIS_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_pressure_plate", PELTOGYNE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_pressure_plate", PIN_CHERRY_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_pressure_plate", PLUM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_pressure_plate", PURFUNGA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_pressure_plate", RARK_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_pressure_plate", RED_ELM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_pressure_plate", RHADI_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_pressure_plate", SANGUART_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_pressure_plate", SCARLET_THIORCEN_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_pressure_plate", SPROOM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_pressure_plate", SEQUOIA_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_pressure_plate", STORTREEAN_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_pressure_plate", STROOMEAN_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_pressure_plate", SUNRISE_FUNGUS_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_pressure_plate", TARK_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_pressure_plate", TEAK_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_pressure_plate", THUNDERCLOUD_PLUM_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_pressure_plate", VYNHERT_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_pressure_plate", WART_TREE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_pressure_plate", WENGE_PRESSURE_PLATE, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_pressure_plate", YEW_PRESSURE_PLATE, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_sapling", ALMOND_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_sapling", ANAMEATA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_sapling", ANGELS_TRUMPET_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_sapling", AQUEAN_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_sapling", BARSHROOKLE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_sapling", BLACK_BIRCH_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_sapling", BLUE_MAHOE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_sapling", BLUE_SPRUCE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_sapling", BOTTLEBRUSH_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_sapling", BROMYA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_sapling", BUBBLETREE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_sapling", CALCEARB_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_sapling", CHERRY_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_sapling", COOK_PINE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_sapling", CROLOOD_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_sapling", DARK_CROLOOD_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_sapling", DARK_FUCHSITRA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_sapling", DARK_RED_ELM_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_sapling", EBONY_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_sapling", ENDERHEART_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_sapling", FRUCE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_sapling", FUCHSITRA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_sapling", FUNERANITE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_sapling", GHOSHROOM_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_sapling", GUAIACUM_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_sapling", JOSHUA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_sapling", KLINKII_PINE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_sapling", MELALEUCA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_sapling", MURKANTUAN_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_sapling", NORFOLK_PINE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_sapling", ORHPRIS_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_sapling", PELTOGYNE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_sapling", PIN_CHERRY_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_sapling", PLUM_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_sapling", PURFUNGA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_sapling", RARK_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_sapling", RED_ELM_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_sapling", RHADI_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_sapling", SANGUART_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_sapling", SPROOM_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_sapling", SEQUOIA_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_sapling", STORTREEAN_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_sapling", STROOMEAN_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_sapling", SUNRISE_FUNGUS_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_sapling", TARK_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_sapling", TEAK_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_sapling", THUNDERCLOUD_PLUM_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_sapling", VYNHERT_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_sapling", WENGE_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_sapling", YEW_SAPLING, PHYTOLOGY);
		...
		createBlockItem("deep_trenches:almond_slab", ALMOND_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_slab", ANAMEATA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_slab", ANGELS_TRUMPET_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_slab", AQUEAN_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_slab", BARSHROOKLE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_slab", BLACK_BIRCH_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_slab", BLUE_MAHOE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_slab", BLUE_SPRUCE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_slab", BOTTLEBRUSH_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_slab", BROMYA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_slab", BUBBLETREE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_slab", CALCEARB_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_slab", CHERRY_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_slab", CHOTORN_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_slab", COOK_PINE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_slab", CROLOOD_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_slab", DARK_CROLOOD_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_slab", DARK_FUCHSITRA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_slab", DARK_RED_ELM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_slab", DEAD_WART_TREE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_slab", DRIGYUS_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_slab", EBONY_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_slab", ENDERHEART_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_slab", FLALM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_slab", FRUCE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_slab", FUCHSITRA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_slab", FUGMOS_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_slab", FUNERANITE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_slab", GHOSHROOM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_slab", GIANT_VIOLET_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_slab", GUAIACUM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_slab", JOSHUA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_slab", KLINKII_PINE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_slab", MELALEUCA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_slab", MURKANTUAN_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_slab", NORFOLK_PINE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_slab", OBSCRUS_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_slab", ORHPRIS_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_slab", PELTOGYNE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_slab", PIN_CHERRY_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_slab", PLUM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_slab", PURFUNGA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_slab", RARK_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_slab", RED_ELM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_slab", RHADI_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_slab", SANGUART_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_slab", SCARLET_THIORCEN_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_slab", SPROOM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_slab", SEQUOIA_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_slab", STORTREEAN_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_slab", STROOMEAN_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_slab", SUNRISE_FUNGUS_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_slab", TARK_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_slab", TEAK_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_slab", THUNDERCLOUD_PLUM_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_slab", VYNHERT_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_slab", WART_TREE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_slab", WENGE_SLAB, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_slab", YEW_SLAB, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_stairs", ALMOND_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_stairs", ANAMEATA_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_stairs", ANGELS_TRUMPET_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_stairs", AQUEAN_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_stairs", BARSHROOKLE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_stairs", BLACK_BIRCH_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_stairs", BLUE_MAHOE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_stairs", BLUE_SPRUCE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_stairs", BOTTLEBRUSH_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_stairs", BROMYA_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_stairs", BUBBLETREE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_stairs", CALCEARB_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_stairs", CHERRY_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_stairs", CHOTORN_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_stairs", COOK_PINE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_stairs", CROLOOD_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_stairs", DARK_CROLOOD_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_stairs", DARK_FUCHSITRA_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_stairs", DARK_RED_ELM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_stairs", DEAD_WART_TREE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_stairs", DRIGYUS_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_stairs", EBONY_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_stairs", ENDERHEART_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_stairs", FLALM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_stairs", FRUCE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_stairs", FUCHSITRA_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_stairs", FUGMOS_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_stairs", FUNERANITE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_stairs", GHOSHROOM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_stairs", GIANT_VIOLET_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_stairs", GUAIACUM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_stairs", JOSHUA_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_stairs", KLINKII_PINE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_stairs", MELALEUCA_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_stairs", MURKANTUAN_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_stairs", NORFOLK_PINE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_stairs", OBSCRUS_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_stairs", ORHPRIS_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_stairs", PELTOGYNE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_stairs", PIN_CHERRY_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_stairs", PLUM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_stairs", PURFUNGA_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_stairs", RARK_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_stairs", RED_ELM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_stairs", RHADI_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_stairs", SANGUART_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_stairs", SCARLET_THIORCEN_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_stairs", SPROOM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_stairs", SANGUART_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_stairs", STORTREEAN_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_stairs", STROOMEAN_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_stairs", SUNRISE_FUNGUS_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_stairs", TARK_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_stairs", TEAK_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_stairs", THUNDERCLOUD_PLUM_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_stairs", VYNHERT_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_stairs", WART_TREE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_stairs", WENGE_STAIRS, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_stairs", YEW_STAIRS, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_trapdoor", ALMOND_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_trapdoor", ANAMEATA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_trapdoor", ANGELS_TRUMPET_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_trapdoor", AQUEAN_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_trapdoor", BARSHROOKLE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_trapdoor", BLACK_BIRCH_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_trapdoor", BLUE_MAHOE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_trapdoor", BLUE_SPRUCE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_trapdoor", BOTTLEBRUSH_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_trapdoor", BROMYA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_trapdoor", BUBBLETREE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_trapdoor", CALCEARB_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_trapdoor", CHERRY_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_trapdoor", CHOTORN_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_trapdoor", COOK_PINE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_trapdoor", CROLOOD_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_trapdoor", DARK_CROLOOD_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_trapdoor", DARK_FUCHSITRA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_trapdoor", DARK_RED_ELM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_trapdoor", DEAD_WART_TREE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_trapdoor", DRIGYUS_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_trapdoor", EBONY_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_trapdoor", ENDERHEART_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_trapdoor", FLALM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_trapdoor", FRUCE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_trapdoor", FUCHSITRA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_trapdoor", FUGMOS_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_trapdoor", FUNERANITE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_trapdoor", GHOSHROOM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_trapdoor", GIANT_VIOLET_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_trapdoor", GUAIACUM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_trapdoor", JOSHUA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_trapdoor", KLINKII_PINE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_trapdoor", MELALEUCA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_trapdoor", MURKANTUAN_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_trapdoor", NORFOLK_PINE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_trapdoor", OBSCRUS_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_trapdoor", ORHPRIS_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_trapdoor", PELTOGYNE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_trapdoor", PIN_CHERRY_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_trapdoor", PLUM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_trapdoor", PURFUNGA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_trapdoor", RARK_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_trapdoor", RED_ELM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_trapdoor", RHADI_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_trapdoor", SANGUART_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_trapdoor", SCARLET_THIORCEN_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_trapdoor", SPROOM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_trapdoor", SEQUOIA_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_trapdoor", STORTREEAN_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_trapdoor", STROOMEAN_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_trapdoor", SUNRISE_FUNGUS_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_trapdoor", TARK_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_trapdoor", TEAK_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_trapdoor", THUNDERCLOUD_PLUM_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_trapdoor", VYNHERT_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_trapdoor", WART_TREE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_trapdoor", WENGE_TRAPDOOR, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_trapdoor", YEW_TRAPDOOR, PHYTOLOGY);

		createBlockItem("deep_trenches:almond_wood", ALMOND_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:anameata_wood", ANAMEATA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:angels_trumpet_wood", ANGELS_TRUMPET_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:aquean_wood", AQUEAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:barshrookle_wood", BARSHROOKLE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:black_birch_wood", BLACK_BIRCH_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_mahoe_wood", BLUE_MAHOE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:blue_spruce_wood", BLUE_SPRUCE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:bottlebrush_wood", BOTTLEBRUSH_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_wood", BROMYA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:bubbletree_wood", BUBBLETREE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:calcearb_wood", CALCEARB_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:cherry_wood", CHERRY_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:chotorn_wood", CHOTORN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:cook_pine_wood", COOK_PINE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:crolood_wood", CROLOOD_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_crolood_wood", DARK_CROLOOD_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_fuchsitra_wood", DARK_FUCHSITRA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:dark_red_elm_wood", DARK_RED_ELM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:dead_wart_tree_wood", DEAD_WART_TREE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus_wood", DRIGYUS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:ebony_wood", EBONY_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:enderheart_wood", ENDERHEART_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm_wood", FLALM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:fruce_wood", FRUCE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:fuchsitra_wood", FUCHSITRA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_wood", FUGMOS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:funeranite_wood", FUNERANITE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:ghoshroom_wood", GHOSHROOM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:giant_violet_wood", GIANT_VIOLET_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_wood", GUAIACUM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:joshua_wood", JOSHUA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:klinkii_pine_wood", KLINKII_PINE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_wood", MELALEUCA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_wood", MURKANTUAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:norfolk_pine_wood", NORFOLK_PINE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus_wood", OBSCRUS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:orhpris_wood", ORHPRIS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:peltogyne_wood", PELTOGYNE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:pin_cherry_wood", PIN_CHERRY_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:plum_wood", PLUM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:purfunga_wood", PURFUNGA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:rark_wood", RARK_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:red_elm_wood", RED_ELM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_wood", RHADI_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:sanguart_wood", SANGUART_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen_wood", SCARLET_THIORCEN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:sproom_wood", SPROOM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:sequoia_wood", SEQUOIA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stortreean_wood", STORTREEAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stroomean_wood", STROOMEAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:sunrise_fungus_wood", SUNRISE_FUNGUS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:tark_wood", TARK_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:teak_wood", TEAK_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:thundercloud_plum_wood", THUNDERCLOUD_PLUM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_wood", VYNHERT_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_wood", WART_TREE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:wenge_wood", WENGE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:yew_wood", YEW_WOOD, PHYTOLOGY);

		createBlockItem("deep_trenches:stripped_almond_log", STRIPPED_ALMOND_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_anameata_log", STRIPPED_ANAMEATA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_angels_trumpet_log", STRIPPED_ANGELS_TRUMPET_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_aquean_log", STRIPPED_AQUEAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_barshrookle_log", STRIPPED_BARSHROOKLE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_black_birch_log", STRIPPED_BLACK_BIRCH_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_bottlebrush_log", STRIPPED_BOTTLEBRUSH_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_blue_mahoe_log", STRIPPED_BLUE_MAHOE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_blue_spruce_log", STRIPPED_BLUE_SPRUCE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_bromya_log", STRIPPED_BROMYA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_bubbletree_log", STRIPPED_BUBBLETREE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_calcearb_log", STRIPPED_CALCEARB_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_cherry_log", STRIPPED_CHERRY_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_cook_pine_log", STRIPPED_COOK_PINE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_chotorn_log", STRIPPED_CHOTORN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_crolood_log", STRIPPED_CROLOOD_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dark_crolood_log", STRIPPED_DARK_CROLOOD_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dark_fuchsitra_log", STRIPPED_DARK_FUCHSITRA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dark_red_elm_log", STRIPPED_DARK_RED_ELM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dead_wart_tree_log", STRIPPED_DEAD_WART_TREE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_drigyus_log", STRIPPED_DRIGYUS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_ebony_log", STRIPPED_EBONY_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_enderheart_log", STRIPPED_ENDERHEART_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_fruce_log", STRIPPED_FRUCE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_funeranite_log", STRIPPED_FUNERANITE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_fuchsitra_log", STRIPPED_FUCHSITRA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_fugmos_stem", STRIPPED_FUGMOS_STEM, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_ghoshroom_log", STRIPPED_GHOSHROOM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_giant_violet_stem", STRIPPED_GIANT_VIOLET_STEM, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_guaiacum_log", STRIPPED_GUAIACUM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_joshua_log", STRIPPED_JOSHUA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_klinkii_pine_log", STRIPPED_KLINKII_PINE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_melaleuca_log", STRIPPED_MELALEUCA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_murkantuan_log", STRIPPED_MURKANTUAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_norfolk_pine_log", STRIPPED_NORFOLK_PINE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_obscrus_log", STRIPPED_OBSCRUS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_orhpris_log", STRIPPED_ORHPRIS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_peltogyne_log", STRIPPED_PELTOGYNE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_pin_cherry_log", STRIPPED_PIN_CHERRY_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_plum_log", STRIPPED_PLUM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_purfunga_log", STRIPPED_PURFUNGA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_rark_log", STRIPPED_RARK_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_red_elm_log", STRIPPED_RED_ELM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_rhadi_log", STRIPPED_RHADI_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sanguart_log", STRIPPED_SANGUART_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_scarlet_thiorcen_log", STRIPPED_SCARLET_THIORCEN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sequoia_log", STRIPPED_SEQUOIA_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sproom_log", STRIPPED_SPROOM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_stortreean_log", STRIPPED_STORTREEAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_stroomean_log", STRIPPED_STROOMEAN_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sunrise_fungus_log", STRIPPED_SUNRISE_FUNGUS_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_tark_log", STRIPPED_TARK_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_teak_log", STRIPPED_TEAK_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_thundercloud_plum_log", STRIPPED_THUNDERCLOUD_PLUM_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_vynhert_log", STRIPPED_VYNHERT_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_wart_tree_log", STRIPPED_WART_TREE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_wenge_log", STRIPPED_WENGE_LOG, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_yew_log", STRIPPED_YEW_LOG, PHYTOLOGY);

		createBlockItem("deep_trenches:stripped_almond_wood", STRIPPED_ALMOND_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_anameata_wood", STRIPPED_ANAMEATA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_angels_trumpet_wood", STRIPPED_ANGELS_TRUMPET_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_aquean_wood", STRIPPED_AQUEAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_barshrookle_wood", STRIPPED_BARSHROOKLE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_black_birch_wood", STRIPPED_BLACK_BIRCH_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_bottlebrush_wood", STRIPPED_BOTTLEBRUSH_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_blue_mahoe_wood", STRIPPED_BLUE_MAHOE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_blue_spruce_wood", STRIPPED_BLUE_SPRUCE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_bromya_wood", STRIPPED_BROMYA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_bubbletree_wood", STRIPPED_BUBBLETREE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_calcearb_wood", STRIPPED_CALCEARB_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_cherry_wood", STRIPPED_CHERRY_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_chotorn_wood", STRIPPED_CHOTORN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_cook_pine_wood", STRIPPED_COOK_PINE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_crolood_wood", STRIPPED_CROLOOD_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dark_crolood_wood", STRIPPED_DARK_CROLOOD_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dark_fuchsitra_wood", STRIPPED_DARK_FUCHSITRA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dark_red_elm_wood", STRIPPED_DARK_RED_ELM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_dead_wart_tree_wood", STRIPPED_DEAD_WART_TREE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_drigyus_wood", STRIPPED_DRIGYUS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_ebony_wood", STRIPPED_EBONY_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_enderheart_wood", STRIPPED_ENDERHEART_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_flalm_stem", STRIPPED_FLALM_STEM, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_flalm_wood", STRIPPED_FLALM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_fruce_wood", STRIPPED_FRUCE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_fuchsitra_wood", STRIPPED_FUCHSITRA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_fugmos_hyphae", STRIPPED_FUGMOS_HYPHAE, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_funeranite_wood", STRIPPED_FUNERANITE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_ghoshroom_wood", STRIPPED_GHOSHROOM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_giant_violet_wood", STRIPPED_GIANT_VIOLET_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_guaiacum_wood", STRIPPED_GUAIACUM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_joshua_wood", STRIPPED_JOSHUA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_klinkii_pine_wood", STRIPPED_KLINKII_PINE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_melaleuca_wood", STRIPPED_MELALEUCA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_murkantuan_wood", STRIPPED_MURKANTUAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_norfolk_pine_wood", STRIPPED_NORFOLK_PINE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_obscrus_wood", STRIPPED_OBSCRUS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_orhpris_wood", STRIPPED_ORHPRIS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_peltogyne_wood", STRIPPED_PELTOGYNE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_pin_cherry_wood", STRIPPED_PIN_CHERRY_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_plum_wood", STRIPPED_PLUM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_purfunga_wood", STRIPPED_PURFUNGA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_rark_wood", STRIPPED_RARK_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_red_elm_wood", STRIPPED_RED_ELM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_rhadi_wood", STRIPPED_RHADI_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sanguart_wood", STRIPPED_SANGUART_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_scarlet_thiorcen_wood", STRIPPED_SCARLET_THIORCEN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sequoia_wood", STRIPPED_SEQUOIA_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sproom_wood", STRIPPED_SPROOM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_stortreean_wood", STRIPPED_STORTREEAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_stroomean_wood", STRIPPED_STROOMEAN_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_sunrise_fungus_wood", STRIPPED_SUNRISE_FUNGUS_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_tark_wood", STRIPPED_TARK_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_teak_wood", STRIPPED_TEAK_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_thundercloud_plum_wood", STRIPPED_THUNDERCLOUD_PLUM_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_vynhert_wood", STRIPPED_VYNHERT_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_wart_tree_wood", STRIPPED_WART_TREE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_wenge_wood", STRIPPED_WENGE_WOOD, PHYTOLOGY);
		createBlockItem("deep_trenches:stripped_yew_wood", STRIPPED_YEW_WOOD, PHYTOLOGY);

		createBlockItem("deep_trenches:bubbletree_bubbles", BUBBLETREE_BUBBLES, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos_moss", FUGMOS_MOSS, PHYTOLOGY);
		createBlockItem("deep_trenches:wart_tree_warts", WART_TREE_WARTS, PHYTOLOGY);

		createBlockItem("deep_trenches:stasp_nest", STASP_NEST, PHYTOLOGY);

		createBlockItem("deep_trenches:rhadi_fruit", RHADI_FRUIT, PHYTOLOGY);
		createBlockItem("deep_trenches:carved_rhadi_fruit", CARVED_RHADI_FRUIT, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_o_lantern", RHADI_O_LANTERN, PHYTOLOGY);

		createBlockItem("deep_trenches:vynhert_fruit", VYNHERT_FRUIT, PHYTOLOGY);
		createBlockItem("deep_trenches:carved_vynhert_fruit", CARVED_VYNHERT_FRUIT, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_o_lantern", VYNHERT_O_LANTERN, PHYTOLOGY);
		...
		createBlockItem("deep_trenches:flalm_petal_block", FLALM_PETAL_BLOCK, PHYTOLOGY);
		...
		AIRIAL_MOSS = createBlockItem("deep_trenches:airial_moss", DTBlocks.AIRIAL_MOSS, PHYTOLOGY);

		createBlockItem("deep_trenches:light_opalite", LIGHT_OPALITE, PHYTOLOGY);
		createBlockItem("deep_trenches:lushine", LUSHINE, PHYTOLOGY);
		createBlockItem("deep_trenches:lushine_pillar", LUSHINE_PILLAR, PHYTOLOGY);
		createBlockItem("deep_trenches:lustrite", LUSTRITE, PHYTOLOGY);
		createBlockItem("deep_trenches:marine_snow", MARINE_SNOW, PHYTOLOGY);
		createBlockItem("deep_trenches:opalite", OPALITE, PHYTOLOGY);
		createBlockItem("deep_trenches:rhodonite", RHODONITE, PHYTOLOGY);
		createBlockItem("deep_trenches:storcean_marine_snow", STORCEAN_MARINE_SNOW, PHYTOLOGY);
		createBlockItem("deep_trenches:storcendite", STORCENDITE, PHYTOLOGY);
		createBlockItem("deep_trenches:storcerack", STORCERACK, PHYTOLOGY);

		createBlockItem("deep_trenches:skystone", SKYSTONE, PHYTOLOGY);
		createBlockItem("deep_trenches:skysoil", SKYSOIL, PHYTOLOGY);
		createBlockItem("deep_trenches:sprilium", SPRILIUM, PHYTOLOGY);
		createBlockItem("deep_trenches:verdine", VERDINE, PHYTOLOGY);
		createBlockItem("deep_trenches:enrotium", ENROTIUM, PHYTOLOGY);
		createBlockItem("deep_trenches:poinine", POININE, PHYTOLOGY);
		createBlockItem("deep_trenches:mosoil", MOSOIL, PHYTOLOGY);
		createBlockItem("deep_trenches:dritean", DRITEAN, PHYTOLOGY);

		createBlockItem("deep_trenches:bottlebrush_flowers", BOTTLEBRUSH_FLOWERS, PHYTOLOGY);
		createBlockItem("deep_trenches:guaiacum_flowers", GUAIACUM_FLOWERS, PHYTOLOGY);
		createBlockItem("deep_trenches:melaleuca_flowers", MELALEUCA_FLOWERS, PHYTOLOGY);
		...
		createBlockItem("deep_trenches:chotorn", CHOTORN_SAPLING, PHYTOLOGY);
		createBlockItem("deep_trenches:drigyus", DRIGYUS, PHYTOLOGY);
		createBlockItem("deep_trenches:flalm", FLALM, PHYTOLOGY);
		createBlockItem("deep_trenches:fugmos", FUGMOS, PHYTOLOGY);
		createBlockItem("deep_trenches:obscrus", OBSCRUS, PHYTOLOGY);
		createBlockItem("deep_trenches:scarlet_thiorcen", SCARLET_THIORCEN, PHYTOLOGY);

		createBlockItem("deep_trenches:enderheart_leaf", ENDERHEART_LEAF, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_leaf", VYNHERT_LEAF, PHYTOLOGY);

		createBlockItem("deep_trenches:flalm_thorns", FLALM_THORNS, PHYTOLOGY);
		createBlockItem("deep_trenches:rhadi_thorns", RHADI_THORNS, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_thorns", VYNHERT_THORNS, PHYTOLOGY);
		createBlockItem("deep_trenches:vynhert_tentacles", VYNHERT_TENTACLES, PHYTOLOGY);

		createBlockItem("deep_trenches:blue_mahoe_flower", BLUE_MAHOE_FLOWER, PHYTOLOGY);
		createBlockItem("deep_trenches:bromya_flower", BROMYA_FLOWER, PHYTOLOGY);
		createBlockItem("deep_trenches:murkantuan_flower", MURKANTUAN_FLOWER, PHYTOLOGY);
		...
		createBlockItem("deep_trenches:poppy", DTBlocks.POPPY, PHYTOLOGY);
		...
		/* -------------------------------- STICK ------------------------------------------- */
		ALMOND_STICK = createItem("deep_trenches:almond_stick", PHYTOLOGY);
		ANAMEATA_STICK = createItem("deep_trenches:anameata_stick", PHYTOLOGY);
		ANGELS_TRUMPET_STICK = createItem("deep_trenches:angels_trumpet_stick", PHYTOLOGY);
		AQUEAN_STICK = createItem("deep_trenches:aquean_stick", PHYTOLOGY);
		BARSHROOKLE_STICK = createItem("deep_trenches:barshrookle_stick", PHYTOLOGY);
		BLACK_BIRCH_STICK = createItem("deep_trenches:black_birch_stick", PHYTOLOGY);
		BLUE_MAHOE_STICK = createItem("deep_trenches:blue_mahoe_stick", PHYTOLOGY);
		BLUE_SPRUCE_STICK = createItem("deep_trenches:blue_spruce_stick", PHYTOLOGY);
		BOTTLEBRUSH_STICK = createItem("deep_trenches:bottlebrush_stick", PHYTOLOGY);
		BROMYA_STICK = createItem("deep_trenches:bromya_stick", PHYTOLOGY);
		BUBBLETREE_STICK = createItem("deep_trenches:bubbletree_stick", PHYTOLOGY);
		CALCEARB_STICK = createItem("deep_trenches:calcearb_stick", PHYTOLOGY);
		CHERRY_STICK = createItem("deep_trenches:cherry_stick", PHYTOLOGY);
		CHOTORN_STICK = createItem("deep_trenches:chotorn_stick", PHYTOLOGY);
		COOK_PINE_STICK = createItem("deep_trenches:cook_pine_stick", PHYTOLOGY);
		CROLOOD_STICK = createItem("deep_trenches:crolood_stick", PHYTOLOGY);
		DARK_CROLOOD_STICK = createItem("deep_trenches:dark_crolood_stick", PHYTOLOGY);
		DARK_FUSHSITRA_STICK = createItem("deep_trenches:dark_fuchsitra_stick", PHYTOLOGY);
		DARK_RED_ELM_STICK = createItem("deep_trenches:dark_red_elm_stick", PHYTOLOGY);
		DEAD_WART_TREE_STICK = createItem("deep_trenches:dead_wart_tree_stick", PHYTOLOGY);
		DRIGYUS_STICK = createItem("deep_trenches:drigyus_stick", PHYTOLOGY);
		EBONY_STICK = createItem("deep_trenches:ebony_stick", PHYTOLOGY);
		ENDERHEART_STICK = createItem("deep_trenches:enderheart_stick", PHYTOLOGY);
		FLALM_STICK = createItem("deep_trenches:flalm_stick", PHYTOLOGY);
		FRUCE_STICK = createItem("deep_trenches:fruce_stick", PHYTOLOGY);
		FUCHSITRA_STICK = createItem("deep_trenches:fuchsitra_stick", PHYTOLOGY);
		FUGMOS_STICK = createItem("deep_trenches:fugmos_stick", PHYTOLOGY);
		FUNERANITE_STICK = createItem("deep_trenches:funeranite_stick", PHYTOLOGY);
		GHOSHROOM_STICK = createItem("deep_trenches:ghoshroom_stick", PHYTOLOGY);
		GIANT_VIOLET_STICK = createItem("deep_trenches:giant_violet_stick", PHYTOLOGY);
		GUAIACUM_STICK = createItem("deep_trenches:guaiacum_stick", PHYTOLOGY);
		JOSHUA_STICK = createItem("deep_trenches:joshua_stick", PHYTOLOGY);
		KLINKII_PINE_STICK = createItem("deep_trenches:klinkii_pine_stick", PHYTOLOGY);
		MELALEUCA_STICK = createItem("deep_trenches:melaleuca_stick", PHYTOLOGY);
		GYLDELION_STICK = createItem("deep_trenches:gyldelion_stick", PHYTOLOGY);
		MURKANTUAN_STICK = createItem("deep_trenches:murkantuan_stick", PHYTOLOGY);
		NORFOLK_PINE_STICK = createItem("deep_trenches:norfolk_pine_stick", PHYTOLOGY);
		OBSCRUS_STICK = createItem("deep_trenches:obscrus_stick", PHYTOLOGY);
		ORHPRIS_STICK = createItem("deep_trenches:orhpris_stick", PHYTOLOGY);
		PELTOGYNE_STICK = createItem("deep_trenches:peltogyne_stick", PHYTOLOGY);
		PIN_CHERRY_STICK = createItem("deep_trenches:pin_cherry_stick", PHYTOLOGY);
		PLUM_STICK = createItem("deep_trenches:plum_stick", PHYTOLOGY);
		PURFUNGA_STICK = createItem("deep_trenches:purfunga_stick", PHYTOLOGY);
		RARK_STICK = createItem("deep_trenches:rark_stick", PHYTOLOGY);
		RED_ELM_STICK = createItem("deep_trenches:red_elm_stick", PHYTOLOGY);
		RHADI_STICK = createItem("deep_trenches:rhadi_stick", PHYTOLOGY);
		SANGUART_STICK = createItem("deep_trenches:sanguart_stick", PHYTOLOGY);
		SCARLET_THIORCEN_STICK = createItem("deep_trenches:scarlet_thiorcen_stick", PHYTOLOGY);
		SEQUOIA_STICK = createItem("deep_trenches:sequoia_stick", PHYTOLOGY);
		SPROOM_STICK = createItem("deep_trenches:sproom_stick", PHYTOLOGY);
		STORTREEAN_STICK = createItem("deep_trenches:stortreean_stick", PHYTOLOGY);
		STROOMEAN_STICK = createItem("deep_trenches:stroomean_stick", PHYTOLOGY);
		SUNRISE_FUNGUS_STICK = createItem("deep_trenches:sunrise_fungus_stick", PHYTOLOGY);
		TARK_STICK = createItem("deep_trenches:tark_stick", PHYTOLOGY);
		TEAK_STICK = createItem("deep_trenches:teak_stick", PHYTOLOGY);
		THUNDERCLOUD_PLUM_STICK = createItem("deep_trenches:thundercloud_plum_stick", PHYTOLOGY);
		VYNHERT_STICK = createItem("deep_trenches:vynhert_stick", PHYTOLOGY);
		WART_TREE_STICK = createItem("deep_trenches:wart_tree_stick", PHYTOLOGY);
		WENGE_STICK = createItem("deep_trenches:wenge_stick", PHYTOLOGY);
		YEW_STICK = createItem("deep_trenches:yew_stick", PHYTOLOGY);
