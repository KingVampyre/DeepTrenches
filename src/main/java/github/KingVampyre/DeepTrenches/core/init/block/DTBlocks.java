...
import github.KingVampyre.DeepTrenches.core.init.world.DTSaplingGenerators;
import github.KingVampyre.DeepTrenches.core.init.DTSignTypes;
import github.KingVampyre.DeepTrenches.core.init.world.DTConfiguredFeatures;
...
public class DTBlocks {
	...
	public static final Block STORCENDITE_ACTINIUM_ORE;
	...
	public static final Block STORCERACK_ENSTATITE_ORE;
	...
	static {
		...
		STORCENDITE_ACTINIUM_ORE = createOre();
		...
		STORCERACK_ENSTATITE_ORE = createOre(3.0F, 3, 7);
	...
	public static void initialize() {
		...
		Registry.register(BLOCK, "deep_trenches:storcendite_actinium_ore", STORCENDITE_ACTINIUM_ORE);
