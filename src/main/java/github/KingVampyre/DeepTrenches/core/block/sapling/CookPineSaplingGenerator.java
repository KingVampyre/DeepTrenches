...
public class CookPineSaplingGenerator implements FeaturesThickSaplingGenerator {
    ...
    private static final ImmutableMap<BlockRotation, Identifier> FEATURES = ImmutableMap.<BlockRotation, Identifier>builder()
    ...
    public ConfiguredFeature<?, ?> createThickTreeFeature(Random random, boolean sapling) {
        ...
        Identifier feature = FEATURES.get(rotation);

        return CONFIGURED_FEATURE.get(feature);
    }
