...
public class StroomeanSaplingGenerator implements FeaturesThickSaplingGenerator {
    ...
    private static final ImmutableMap<BlockRotation, Identifier> STROOMEAN = ImmutableMap.<BlockRotation, Identifier>builder()
            .put(NONE, new Identifier("deep_trenches:stroomean"))
            .put(CLOCKWISE_90, new Identifier("deep_trenches:stroomean_90"))
            .put(CLOCKWISE_180, new Identifier("deep_trenches:stroomean_180"))
            .put(COUNTERCLOCKWISE_90, new Identifier("deep_trenches:stroomean_270"))
            .build();

    @Override
    public ConfiguredFeature<?, ?> createThickTreeFeature(Random random, boolean sapling) {
        BlockRotation rotation = BlockRotation.random(random);
        Identifier id = STROOMEAN.get(rotation);
