...
public class VineFlowersBlock extends VineBlock {

    protected final Tag<Block> tag;

    public VineFlowersBlock(Tag<Block> tag, Settings settings) {
        super(settings);
    ...
    public boolean checkLeaves(WorldView world, BlockState state, BlockPos pos) {
