...
import static github.KingVampyre.DeepTrenches.core.init.entity.DTEntityTypes.BARBELED_LOOSEJAW;
import static github.KingVampyre.DeepTrenches.core.init.item.DTItems.BARBELED_LOOSEJAW_BUCKET;
