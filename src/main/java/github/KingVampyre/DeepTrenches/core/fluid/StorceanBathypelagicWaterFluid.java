...
import static github.KingVampyre.DeepTrenches.core.init.DTFluids.FLOWING_STORCEAN_BATHYPELAGIC_WATER;
import static github.KingVampyre.DeepTrenches.core.init.DTFluids.STORCEAN_BATHYPELAGIC_WATER;
import static github.KingVampyre.DeepTrenches.core.init.DTItems.STORCEAN_BATHYPELAGIC_WATER_BUCKET;
...
public abstract class StorceanBathypelagicWaterFluid extends AbstractOxygenatedWaterFluid implements StatusEffectFluid {
    ...
    protected ParticleEffect getParticle() {
        return ParticleEffectHelper.getDrippingEffect(this, 0.364F, 0.635F, 0.737F);
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return DTBlocks.STORCEAN_BATHYPELAGIC_WATER.getDefaultState().with(FluidBlock.LEVEL, FlowableFluid.getBlockStateLevel(state));
    }
