...
import static github.KingVampyre.DeepTrenches.core.init.ModFluids.STORCEAN_ABYSSOPELAGIC_WATER;
import static github.KingVampyre.DeepTrenches.core.init.ModFluids.FLOWING_STORCEAN_ABYSSOPELAGIC_WATER;

public abstract class StorceanAbyssopelagicWaterFluid extends AbstractWaterFluid {

    @Override
    public Item getBucketItem() {
        return ModItems.STORCEAN_ABYSSOPELAGIC_WATER_BUCKET;
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == STORCEAN_ABYSSOPELAGIC_WATER || fluid == FLOWING_STORCEAN_ABYSSOPELAGIC_WATER;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModBlocks.STORCEAN_ABYSSOPELAGIC_WATER.getDefaultState().with(FluidBlock.LEVEL, method_15741(state));
    }
