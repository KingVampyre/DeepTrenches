...
public abstract class StorceanInfinipelagicWaterFluid extends AbstractWaterFluid implements FluidStatusEffect, OxygenatedFluid {

    @Override
    public void applyStatusEffects(LivingEntity living) {
        living.addStatusEffect(new StatusEffectInstance(PRESSURE, 120, 4, false, false, true));
    }
