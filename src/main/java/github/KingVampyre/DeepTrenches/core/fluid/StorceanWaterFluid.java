...
import static github.KingVampyre.DeepTrenches.core.init.DTFluids.FLOWING_STORCEAN_WATER;
import static github.KingVampyre.DeepTrenches.core.init.DTFluids.STORCEAN_WATER;
import static github.KingVampyre.DeepTrenches.core.init.DTItems.STORCEAN_WATER_BUCKET;
...
public abstract class StorceanWaterFluid extends AbstractOxygenatedWaterFluid implements StatusEffectFluid {
    ...
    protected ParticleEffect getParticle() {
        return ParticleEffectHelper.getDrippingEffect(this, 0.450F, 0.450F, 0.776F);
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return DTBlocks.STORCEAN_WATER.getDefaultState().with(FluidBlock.LEVEL, FlowableFluid.getBlockStateLevel(state));
    }
